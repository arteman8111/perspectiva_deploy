...
exports.Modals = exports.FocusLock = void 0;
...
var Modals = /*#__PURE__*/function () {
  ...
  _createClass(Modals, [{
    ...
    value: function open() {
      ...
      setTimeout(function () {
        _this2._addListeners(modal);
        _this2._autoPlay(modal);
    ...
    value: function close() {
      ...
      if (this._enableScrolling) {
        setTimeout(function () {
          _this3._scrollLock.enableScrolling();
        }, this._eventTimeout);
      }
      setTimeout(function () {
        document.addEventListener('click', _this3._documentClickHandler);
      }, this._eventTimeout);
